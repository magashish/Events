                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ url('/admin/change-password') }}"><i class="ti-settings m-r-5 m-l-5"></i> Change Password</a>
                                <div class="dropdown-divider"></div>
                                ...
                                <div class="dropdown-divider"></div>
                                <div class="p-l-30 p-10"><a href="{{ url('/admin/profile') }}" class="btn btn-sm btn-success btn-rounded">View Profile</a></div>
                            </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
