                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('admin.siteSetting.update') }}" id="profile-form" method="post">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="stripe_s_key" class="col-sm-2 text-right control-label col-form-label">Secret Key:</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="stripe_p_key" class="col-sm-2 text-right control-label col-form-label">Publishable key:</label>
                                <div class="col-sm-8">
